...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('plugin/DataTables/datatables.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('plugin/DataTables/dataTables.bootstrap.min.css')); ?>">
        <?php echo $__env->yieldContent('css'); ?>

        <!-- Scripts -->
         <script src="<?php echo e(asset('js/jquery-3.2.1.min.js')); ?>"></script>
        <script src="<?php echo e(asset('js/bootstrap.js')); ?>"></script> 
        <script src="<?php echo e(asset('plugin/fontawesome5/svg-with-js/js/fontawesome-all.js')); ?>"></script>
        <script>
    ...
    <body>
        ...
        <script src="<?php echo e(asset('plugin/DataTables/dataTables.bootstrap.min.js')); ?>"></script>
