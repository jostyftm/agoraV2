	...
	<ul class="sidebar-nav nav-pills nav-stacked" id="menu">
        ...
        <li class="">
            ...
            <ul id="collapse-headquarter" class="nav-pills nav-stacked collapse collapseable" style="list-style-type:none;">
                <li><a href="<?php echo e(route('headquarter.create')); ?>">Crear</a></li>
                <li><a href="<?php echo e(route('headquarter.index')); ?>">Ver Sedes</a></li>
            </ul>
        </li>
		<!-- Inscripción -->
        <li class="">
            ...
            <ul id="collapse-inscription" class="nav-pills nav-stacked collapse collapseable" style="list-style-type:none;">
                ...
                <li><a href="<?php echo e(route('enrollment.lists', 1)); ?>">Ver</a></li>
                <li><a href="<?php echo e(route('enrollment.card.grade')); ?>">Ficha Académica</a></li>
            </ul>
        </li>
        <!-- Grupo -->
        <li class="">
            ...
            <ul id="collapse-group" class="nav-pills nav-stacked collapse collapseable" style="list-style-type:none;">
                <li><a href="<?php echo e(route('group.create')); ?>">Crear</a></li>
                <li><a href="<?php echo e(route('group.index')); ?>">Ver grupos</a></li>
            </ul>
        </li>
	</ul>
</div>