<div class="modal fade bs-example-modal-lg" id="modalEditFamily" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			{!! Form::open(['route' => 'student.index', 'method' => 'put', 'id'=>'formEditFamily']) !!}
						...
						<div class="row">
							<div class="col-md-3">
								...
								{!! Form::label('relationship_id', 'Parentesco') !!}
									{!! Form::select('relationship_id', $relationship_types, old('relationship_id'), ['class'=>'form-control chosen-ri', 'placeholder' => 'Seleccione el parentesco']) !!}
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group{{ $errors->has('identification_type_id') ? ' has-error' : '' }}">
									...
									{!! Form::select('identification_type_id', $identification_types, old('identification_type_id'), ['class'=>'form-control chosen-it', 'placeholder' => 'Seleccione el tipo de identificación']) !!}
								</div>
							</div>
							<div class="col-md-3">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group{{ $errors->has('id_city_expedition') ? ' has-error' : '' }}">
									...
									{!! Form::select('id_city_expedition', $cities, old('id_city_expedition'), ['class'=>'form-control chosen-ice', 'placeholder'=>'Selecciona una ciudad']) !!}
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group{{ $errors->has('id_city_of_birth') ? ' has-error' : '' }}">
									{!! Form::label('id_city_of_birth', 'Ciudad de nacimiento') !!}
									{!! Form::select('id_city_of_birth', $cities, old('id_city_of_birth'), ['class'=>'form-control chosen-icb', 'placeholder'=>'Selecciona una ciudad']) !!}
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group{{ $errors->has('gender_id') ? ' has-error' : '' }}">
									{!! Form::label('gender_id', 'Genero') !!}
									{!! Form::select('gender_id', $genders, old('gender_id'), ['class'=>'form-control chosen-ig', 'placeholder'=>'seleccione un genero']) !!}
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-md-2">
								<div class="form-group {{ $errors->has('mobil') ? ' has-error' : '' }}">
									...
									{!! Form::text('mobil', old('mobil'), ['class' => 'form-control']) !!}
								</div>
							</div>
							<div class="col-md-3">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group {{ $errors->has('id_city_address') ? ' has-error' : '' }}">
									...
									{!! Form::select('id_city_address', $cities, old('id_city_address'), ['class'=>'form-control chosen-ac', 'placeholder'=>'seleccione una ciudad']) !!}
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group {{ $errors->has('zone_id') ? ' has-error' : '' }}">
									{!! Form::label('zone_id', 'Zona') !!}
									{!! Form::select('zone_id', $zones, old('zone_id'), ['class'=>'form-control chosen-az', 'placeholder'=>'seleccione una zona']) !!}
								</div>
							</div>
						</div>
					</div>
