...
@section('content')
    <div class="row">
    	<div class="col-md-12">
			...
			{!! Form::open(['route'=> ['headquarter.update', $headquarter], 'method'=>'put'])!!}
				<div class="panel panel-default">
				  	<div class="panel-heading">
				    	<h3 class="panel-title">Editar sede</h3>
				  	</div>
				  				...
				  				<div class="row">
				  					<div class="col-md-3">
				  						<div class="form-group {{ $errors->has('id_city_address') ? ' has-error' : '' }}">
				  							...
				  							{!! Form::select('id_city_address', $cities, $headquarter->address->id_city_address, ['class'=>'form-control chosen-select', 'placeholder'=>'seleccione una ciudad']) !!}
				  						</div>
				  					</div>
				  					<div class="col-md-3">
				  						<div class="form-group {{ $errors->has('zone_id') ? ' has-error' : '' }}">
				  							{!! Form::label('zone_id', 'Zona') !!}
				  							{!! Form::select('zone_id', $zones, $headquarter->address->zone_id, ['class'=>'form-control chosen-select', 'placeholder'=>'seleccione una zona']) !!}
				  						</div>
				  					</div>
				  				</div>
				  			</div>
